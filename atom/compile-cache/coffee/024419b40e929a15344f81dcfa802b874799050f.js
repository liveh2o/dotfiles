(function() {
  var $, CompositeDisposable, TabView, path,
  ...
  module.exports = TabView = (function(_super) {
    ...
    TabView.prototype.handleEvents = function() {
      ...
      if (typeof this.item.onDidChangeTitle === 'function') {
        this.subscriptions.add(this.item.onDidChangeTitle(titleChangedHandler));
      ...
      if (typeof this.item.onDidChangeIcon === 'function') {
        this.subscriptions.add(typeof (_base = this.item).onDidChangeIcon === "function" ? _base.onDidChangeIcon((function(_this) {
          return function() {
            return _this.updateIcon();
          };
        })(this)) : void 0);
      ...
      if (typeof this.item.onDidChangeModified === 'function') {
        this.subscriptions.add(this.item.onDidChangeModified(modifiedHandler));
      } else if (typeof this.item.on === 'function') {
      ...
      if (typeof this.item.onDidSave === 'function') {
        this.subscriptions.add(this.item.onDidSave((function(_this) {
    ...
    TabView.prototype.destroy = function() {
      ...
      if ((_ref1 = this.mouseEnterSubscription) != null) {
        _ref1.dispose();
      }
      if ((_ref2 = this.repoSubscriptions) != null) {
        _ref2.dispose();
      }
      this.destroyTooltip();
      return this.remove();
    ...
    TabView.prototype.setupVcsStatus = function() {
      ...
      repo = this.repoForPath(this.path);
    ...
    TabView.prototype.subscribeToRepo = function(repo) {
      ...
      if ((_ref = this.repoSubscriptions) != null) {
        _ref.dispose();
      }
    ...
    TabView.prototype.repoForPath = function(goalPath) {
