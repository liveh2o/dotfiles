(function() {
  var $, BrowserWindow, CompositeDisposable, RendererIpc, TabBarView, TabView, TextEditor, View, _, _ref, _ref1,
  ...
  _ref1 = require('atom'), CompositeDisposable = _ref1.CompositeDisposable, TextEditor = _ref1.TextEditor;
  ...
  module.exports = TabBarView = (function(_super) {
    ...
    TabBarView.prototype.destroyPreviousPreviewTab = function() {
      var _ref2;
      if ((_ref2 = this.previewTabToDestroy) != null ? _ref2.isPreviewTab : void 0) {
    ...
    TabBarView.prototype.removeTabForItem = function(item) {
      var tab, _i, _len, _ref2, _ref3;
      if ((_ref2 = this.tabForItem(item)) != null) {
        _ref2.destroy();
      }
      _ref3 = this.getTabs();
    ...
    TabBarView.prototype.setActiveTab = function(tabView) {
      ...
      if ((tabView != null) && !tabView.classList.contains('active')) {
        if ((_ref2 = this.element.querySelector('.tab.active')) != null) {
          _ref2.classList.remove('active');
        }
    ...
    TabBarView.prototype.splitTab = function(fn) {
      var copiedItem, item, _ref2;
      if (item = (_ref2 = this.children('.right-clicked')[0]) != null ? _ref2.item : void 0) {
    ...
    TabBarView.prototype.copyItem = function(item) {
      var _ref2;
      return (_ref2 = typeof item.copy === "function" ? item.copy() : void 0) != null ? _ref2 : atom.deserializers.deserialize(item.serialize());
    };
    ...
    TabBarView.prototype.closeSavedTabs = function() {
      var tab, _base, _i, _len, _ref2, _results;
      _ref2 = this.getTabs();
      _results = [];
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        tab = _ref2[_i];
    ...
    TabBarView.prototype.onDragStart = function(event) {
      var element, item, itemURI, paneIndex, _ref2, _ref3, _ref4;
      ...
      if (typeof item.getURI === 'function') {
        itemURI = (_ref2 = item.getURI()) != null ? _ref2 : '';
      } else if (typeof item.getPath === 'function') {
        itemURI = (_ref3 = item.getPath()) != null ? _ref3 : '';
      } else if (typeof item.getUri === 'function') {
        itemURI = (_ref4 = item.getUri()) != null ? _ref4 : '';
      }
      if (itemURI != null) {
    ...
    TabBarView.prototype.browserWindowForProcessIdAndRoutingId = function(processId, routingId) {
      var browserWindow, _i, _len, _ref2;
      if (BrowserWindow == null) {
        BrowserWindow = require('remote').require('browser-window');
      }
      _ref2 = BrowserWindow.getAllWindows();
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        browserWindow = _ref2[_i];
    ...
    TabBarView.prototype.removePlaceholder = function() {
      var _ref2;
      if ((_ref2 = this.placeholderEl) != null) {
        _ref2.remove();
      }
