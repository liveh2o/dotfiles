(function() {
  ...
  Linter = (function() {
    ...
    Linter.prototype.lintFile = function(filePath, callback) {
      var args, command, dataStderr, dataStdout, exit, exited, options, process, stderr, stdout, _ref1, _ref2;
      ...
      process.onWillThrowError((function(_this) {
        return function(err) {
          var ignored, subtle, warningMessageTitle, _ref3, _ref4, _ref5, _ref6;
          if (err == null) {
            return;
          }
          if (err.error.code === 'ENOENT') {
            ignored = (_ref3 = atom.config.get('linter.ignoredLinterErrors')) != null ? _ref3 : [];
            subtle = (_ref4 = atom.config.get('linter.subtleLinterErrors')) != null ? _ref4 : [];
            warningMessageTitle = "The linter binary '" + _this.linterName + "' cannot be found.";
            if (_ref5 = _this.linterName, __indexOf.call(subtle, _ref5) >= 0) {
              atom.notifications.addError(warningMessageTitle);
            } else if (_ref6 = _this.linterName, __indexOf.call(ignored, _ref6) < 0) {
              atom.confirm({
