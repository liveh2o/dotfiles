(function() {
  ...
  module.exports = TabBarView = (function(_super) {
    ...
    TabBarView.prototype.onDragStart = function(event) {
      ...
      event.originalEvent.dataTransfer.setData('from-window-id', this.getWindowId());
    ...
    TabBarView.prototype.onDrop = function(event) {
      var dataTransfer, droppedURI, fromIndex, fromPane, fromPaneId, fromPaneIndex, fromWindowId, hasUnsavedChanges, item, modifiedText, toIndex, toPane;
      event.preventDefault();
