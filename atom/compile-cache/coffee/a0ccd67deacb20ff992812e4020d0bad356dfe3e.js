(function() {
  var CompositeDisposable, Disposable, Emitter, Grim, Motions, Operators, Point, Prefixes, Range, Scroll, TextObjects, Utils, VimState, getChangesSinceCheckpoint, settings, _, _ref, _ref1,
  ...
  module.exports = VimState = (function() {
    ...
    VimState.prototype.activateReplaceMode = function() {
      ...
      this.replaceModeCheckpoint = null;
    ...
    VimState.prototype.replaceModeInsertHandler = function(event) {
      var char, chars, selection, selections, _i, _len, _ref2, _results;
      chars = ((_ref2 = event.text) != null ? _ref2.split('') : void 0) || [];
      selections = this.editor.getSelections();
      this.replaceModeCheckpoint = this.editor.createCheckpoint();
      _results = [];
        ...
        _results.push((function() {
          ...
          for (_j = 0, _len1 = selections.length; _j < _len1; _j++) {
            ...
            if (!selection.cursor.isAtEndOfLine()) {
              _results1.push(selection["delete"]());
            } else {
    ...
    VimState.prototype.replaceModeUndoHandler = function(event) {
      if (this.replaceModeCheckpoint != null) {
        this.editor.groupChangesSinceCheckpoint(this.replaceModeCheckpoint);
      }
