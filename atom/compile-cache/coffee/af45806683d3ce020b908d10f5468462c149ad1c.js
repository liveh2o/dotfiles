(function() {
  var Change, Delete, Insert, InsertAboveWithNewline, InsertAfter, InsertAfterEndOfLine, InsertAtBeginningOfLine, InsertBelowWithNewline, Operator, ReplaceMode, Substitute, SubstituteLine, TransactionBundler, settings, _, _ref,
  ...
  Substitute = (function(_super) {
    ...
    function Substitute(editor, vimState) {
      this.editor = editor;
      this.vimState = vimState;
      this.register = settings.defaultRegister();
    }
  ...
  SubstituteLine = (function(_super) {
    ...
    function SubstituteLine(editor, vimState) {
      this.editor = editor;
      this.vimState = vimState;
      this.register = settings.defaultRegister();
    }
