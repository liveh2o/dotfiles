(function() {
  var $, TabBarView, TabView, View, buildDragEvents, buildWheelEvent, buildWheelPlusShiftEvent, path, triggerMouseDownEvent, _, _ref, _ref1,
  ...
  describe("TabBarView", function() {
    ...
    return describe("when usePreviewTabs is true in package settings", function() {
      beforeEach(function() {
        atom.config.set("tabs.usePreviewTabs", true);
      ...
      return describe("when a non-text file is opened", function() {
