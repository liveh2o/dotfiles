(function() {
  var $, Disposable, Reporter, ScrollView, WelcomeView, _ref,
  ...
  module.exports = WelcomeView = (function(_super) {
    ...
    WelcomeView.prototype.initialize = function() {
      ...
      return this.on('click', 'a.js-metrics', function() {
        return atom.workspace.open('atom://config/packages/metrics');
      });
    };
